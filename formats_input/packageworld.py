...
class PackageWorldWidget(QWidget):
    def __init__(self):
        super().__init__()
        self.setup_ui()
        self.default_values()
        self.packageworld_widget = None
    ...
    def default_values(self):
        self.customer_input.setText("PackageWorld, Inc.")
        ...
        properties_data = [
            ("Color", "White", "White", "MBPI"),
            ("Specific Gravity", "0.95", "0.95 ± 0.03", "MBPI"),
            ("Durometer Hardness Shore \"A\"", "91.45", "91.0 ± 5.00", "ASTM D 2240"),
