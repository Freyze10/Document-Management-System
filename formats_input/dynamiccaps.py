...
class DynamiccapsWidget(QWidget):
    def __init__(self):
        super().__init__()
        self.setup_ui()
        self.default_values()
        self.dynamiccaps_widget = None
    ...
    def setup_ui(self):
        ...
        general_info_layout.addWidget(QLabel("Code:"), 0, 2, Qt.AlignmentFlag.AlignRight)
        general_info_layout.addWidget(self.code_input, 0, 3)

        # Row 1
        general_info_layout.addWidget(QLabel("Delivery Receipt:"), 1, 0, Qt.AlignmentFlag.AlignRight)
        ...
        general_info_layout.addLayout(receipt_input_layout, 1, 1)
    ...
    def default_values(self):
        self.customer_input.setText("Dynamiccaps Corporation")
        self.product_name_input.setText("PVC-Free Granulate Riteseal 88 WHite")
        ...
        properties_data = [
            ("Color/Appearance", "Natural Pellet", "Natural Pellet", "MBPI"),
            ("Durometer Hardness Shore \"A\"", "92.31", "92 ± 3", "ASTM D 2240"),
            ("Pellet Size Length, mm", "3.00", "3.00 ± 0.50", "MBPI"),
            ("Diameter, mm", "2.90", "3.00 ± 0.50", "MBPI"),
