...
class MainWindow(QMainWindow):
    def __init__(self, username=None):
        ...
        self.sync_update_button = QPushButton("Update")
        self.sync_update_button.setFixedSize(60, 25)
        self.sync_update_button.clicked.connect(self.run_update_sync_script)
